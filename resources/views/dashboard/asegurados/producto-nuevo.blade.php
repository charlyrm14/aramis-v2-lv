<div class="modal fade" id="kt_modal_nuevo_producto" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
                ...
                <div class="d-flex flex-column flex-lg-row">
                    ...
                    <div class="flex-column flex-lg-row-auto w-100 w-lg-300px w-xl-400px mb-10 mb-lg-0">
                        ...
                        <div class="card card-flush">
                            <!--begin::Card header-->
                            <div class="card-header pt-7" id="kt_bar_products">
                                <!--begin::Form-->
                                <form class="w-100 position-relative" autocomplete="off">
                                    ...
                                    <!--end::Icon-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid px-13" name="search" value="" placeholder="Buscar por nombre de producto" />
                                    <!--end::Input-->
                                </form>
                                <!--end::Form-->
                            </div>
                            ...
                            <div class="card-body pt-5" id="kt_chat_contacts_body">
                                <!--begin::List-->
                                <div class="scroll-y me-n5 pe-5 h-200px h-lg-auto" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_header, #kt_app_header, #kt_toolbar, #kt_app_toolbar, #kt_footer, #kt_app_footer, #kt_bar_products" data-kt-scroll-wrappers="#kt_content, #kt_app_content, #kt_chat_contacts_body" data-kt-scroll-offset="5px">
                                    <!--begin::Section-->
                                    <div class="m-0">
                                        <!--begin::Heading-->
                                        <div class="d-flex align-items-center collapsible py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_1_1">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">AMEX GUARD 3.1</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin::Body-->
                                        <div id="kt_job_1_1" class="collapse fs-6 ms-1">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10 mb-n1">
                                                    <!--begin::Bullet-->
                                                    <button class="btn btn-light-primary btn-sm ">Contratar Plan Elite</button>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Item-->
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10 mb-n1">
                                                    <!--begin::Bullet-->
                                                    <button class="btn btn-light-primary btn-sm ">Contratar Plan Advanced</button>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Item-->
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="d-flex align-items-center ps-10 mb-n1">
                                                    <!--begin::Bullet-->
                                                    <button class="btn btn-light-primary btn-sm">Contratar Plan Essential</button>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Item-->
                                            </div>
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center collapsible py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_1_2">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">ESCUDO FAMILIAR</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin::Body-->
                                    ...
                                    <div class="m-0">
                                        ...
                                        <div class="d-flex align-items-center collapsible py-3 toggle mb-0" data-bs-toggle="collapse" data-bs-target="#kt_job_1_3">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <h4 class="text-gray-700 fw-bold cursor-pointer mb-0">CRITICAL ILLNESS V2</h4>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                        <!--begin::Body-->
                    ...
                    <div class="flex-lg-row-fluid ms-lg-7 ms-xl-10">
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                            ...
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab" href="#kt_tab_pane_cotizacion_contratante"> Contratante </a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab" href="#kt_tab_pane_cotizacion_datos_fiscales"> Datos Fiscales </a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab" href="#kt_tab_pane_cotizacion_tarjeta"> Tarjetas </a>
                            </li>
                            <!--end::Nav item-->
                            <!--begin::Nav item-->
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5" data-bs-toggle="tab" href="#kt_tab_pane_cotizacion_poliza"> Póliza </a>
                            </li>
                            <!--end::Nav item-->
                        </ul>
                        <!--end::Messenger-->
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_cotizacion_contratante" role="tabpanel">
                                <div class="my-5">
                                    <div class="mb-15">
                                        <!--begin::Form-->
                                        <form id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_cotizacion_datos_fiscales" role="tabpanel">
                                <div class="my-5">
                                    <div class="mb-15">
                                        <!--begin::Form-->
                                        <form id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_cotizacion_tarjeta" role="tabpanel">
                                <div class="my-5">
                                    <div class="mb-15">
                                        <!--begin::List-->
                                        <div class="mh-375px scroll-y me-n7 pe-7">
                            ...
                            <div class="tab-pane fade" id="kt_tab_pane_cotizacion_poliza" role="tabpanel">
                                <div class="my-5">
                                    <div class="mb-15">
                                        <!--begin::Form-->
                                        <form id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                                            ...
                                            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                                <!--begin::Label-->
                                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                    <span class="required">Certificado</span>
                                                    <span class="ms-1" data-bs-toggle="tooltip" aria-label="Nombre" data-bs-original-title="Nombre" data-kt-initialized="1">
                                                        <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                                                    </span>
                                                </label>
                                                <!--end::Label-->
                                                <input type="text" class="form-control form-control-solid" placeholder="UNICO" name="target_title" disabled>
                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
                                            <!--begin::Input group-->
                                            <!--begin::Input group-->
                                            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <input type="text" class="form-control form-control-solid" placeholder="USD" name="target_title" disabled>
                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
                                            <!--begin::Input group-->
                                            <!--begin::Input group-->
                                            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <input type="text" class="form-control form-control-solid" placeholder="Tarjeta de crédito" name="target_title" disabled>
                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
                                            <!--begin::Input group-->
                                            <!--begin::Input group-->
                                            <div class="d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
                                                <!--begin::Label-->
                                                <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                                    <span class="required">Token tarjeta</span>
                                                    <span class="ms-1" data-bs-toggle="tooltip" aria-label="Nombre" data-bs-original-title="Nombre" data-kt-initialized="1">
                                                        <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                                                    </span>
                                                </label>
                                                <!--end::Label-->
                                                <input type="text" class="form-control form-control-solid" placeholder="crd.0000EgKXkf111hbhLHV8pEGp" name="target_title" disabled>
                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div></div>
                                            <!--begin::Input group-->
                                            <!--begin::Actions-->
                                            <div class="text-center">
