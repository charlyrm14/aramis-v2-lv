...
<html lang="en">
	...
	<head>
<base href="../../" />
		<title>ARAMIS 404</title>
		<meta charset="utf-8" />
		<meta name="description" content="Aramis" />
		<meta name="viewport" content="width=device-width, initial-scale=1" />
		<meta property="og:locale" content="en_US" />
		<meta property="og:type" content="article" />
		<meta property="og:title" content="Aramis" />
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">No encontramos la página que estabas buscando.</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-3">
							...
							<!--begin::Link-->
							<div class="mb-0">
								<a href="{{ route('home') }}" class="btn btn-sm btn-primary">Regresar a inicio</a>
							</div>
							<!--end::Link-->
						</div>
					</div>
